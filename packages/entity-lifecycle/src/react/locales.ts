...
import { EN_US_LIFECYCLE_WEB_COPY } from './en-US';
...
export const LIFECYCLE_WEB_COPY = {
  'pt-BR': PT_BR_LIFECYCLE_WEB_COPY,
  'en-US': EN_US_LIFECYCLE_WEB_COPY,
} as const satisfies LocalePack<LifecycleWebCopy>;
