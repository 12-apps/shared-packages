 ...
 * somewhere. The default remembers it IN THIS PROCESS: a small map of
 ...
 * Single-use is therefore strictly guaranteed only on a SINGLE instance. BEFORE
...
/** The default, in-process store — correct on one instance (see the caveat above). */
