...
export const EN_US_RBAC_WEB_COPY: RbacWebCopy = {
  ...
  teamScreen: {
    ...
    inviteRoleLabel: 'System roles',
    inviteCustomRolesTitle: 'Custom roles',
    inviteNoRole: 'Pick at least one role.',
    inviteHint:
  ...
  teamRoleDialog: {
    ...
    systemGroupTitle: 'System roles',
    customGroupTitle: 'Custom roles',
