...
export const PT_BR_RBAC_WEB_COPY: RbacWebCopy = {
  ...
  teamScreen: {
    ...
    inviteRoleLabel: 'Papéis do sistema',
    inviteCustomRolesTitle: 'Papéis personalizados',
    inviteNoRole: 'Escolha ao menos um papel.',
    inviteHint:
  ...
  teamRoleDialog: {
    ...
    systemGroupTitle: 'Papéis do sistema',
    customGroupTitle: 'Papéis personalizados',
