...
export const PT_BR_DISCOUNTS_WEB_COPY: DiscountsWebCopy = {
  ...
  schedule: {
    sectionTitle: "Quando vale",
    periodTitle: "Período",
    periodHint: "Deixe em branco para valer sem prazo.",
    repetitionTitle: "Repetição",
    always: "Sempre, dentro do período",
    specific: "Em dias e horários específicos",
    builderTitle: "Dias e horários",
    addWindow: "Adicionar outro horário",
    removeWindow: "Remover horário",
    fromLabel: "Das",
    toLabel: "às",
    presetEveryDay: "Todos os dias",
    presetWeekdays: "Seg a Sex",
    presetWeekend: "Fim de semana",
    dayShort: ["Seg", "Ter", "Qua", "Qui", "Sex", "Sáb", "Dom"],
    dayLong: ["segunda", "terça", "quarta", "quinta", "sexta", "sábado", "domingo"],
    dayEvery: [
      "Toda segunda",
      "Toda terça",
      "Toda quarta",
    ...
    daysRequired: "Escolha ao menos um dia.",
    timesRequired: "Informe um horário de início e de fim diferentes.",
    windowsRequired: "Adicione ao menos um horário.",
  },
  form: {
