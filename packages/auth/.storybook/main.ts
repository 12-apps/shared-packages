 ...
 * Storybook in one repo is a third thing to keep working.
 *
 * What is deliberately NOT here: any alias or `optimizeDeps` entry for
 * `@12-apps/ui`. The stories import it the way a consumer would. If that needs
 * special Vite config to resolve, that is a packaging bug in the design system,
