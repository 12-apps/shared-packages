...
// Typed suggestions: search fills the input, link opens a URL (Google-style)
...
const quickSearchItems: QuickSearchItem[] = [
  { id: '1', text: 'Produtos', type: 'search' },
  { id: '2', text: 'Pedidos', type: 'search' },
  { id: '3', text: 'Estoque', type: 'search' },
  { id: '4', text: 'Abrir Storybook', type: 'link', url: 'https://storybook.js.org' },
  { id: '5', text: 'Documentação do Next.js', type: 'link', url: 'https://nextjs.org/docs' },
];

const SearchAndLinkComponent = () => {
  const [value, setValue] = useState('');
  return (
    <Autocomplete<QuickSearchItem>
      ...
      placeholder="Search pages, or open a link..."
    />
  );
};

export const SearchAndLinkSuggestions: Story = {
  render: () => <SearchAndLinkComponent />,
};
