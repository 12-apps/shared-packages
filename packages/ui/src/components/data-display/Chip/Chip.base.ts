...
export interface ChipBaseProps {
  ...
  /**
   * Click/selection handler. The name is the web's on both sides; the native
   * chip also answers to `onPress`, as `Button` does.
   */
  onClick?: () => void;
  ...
  /** React Native's spelling of {@link ChipBaseProps.dataTestId}. */
  testID?: string;
}
