...
- Hover (a brightness step), press (a 20% opacity dip easing back over 1s) and `:focus-visible` (the keyboard ring) have no touch equivalent; the close button's pressed state stands in for its hover.
