    ...
    docs: {
      description: {
        component:
          ...
          'is the ACCESSIBLE representation, because a screen reader cannot read a picture; the ' +
          'map beside it is a named landmark a reader can skip, never an `aria-hidden` subtree.',
      },
    },
  },
  tags: ['autodocs'],
