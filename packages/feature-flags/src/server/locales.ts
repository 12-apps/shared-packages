...
export const FEATURE_FLAGS_SERVER_COPY = {
  "pt-BR": PT_BR_FEATURE_FLAGS_SERVER_COPY,
  "en-US": EN_US_FEATURE_FLAGS_SERVER_COPY,
} as const satisfies LocalePack<FeatureFlagsServerCopy>;
