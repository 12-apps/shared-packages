 ...
 */
import type { FlagDefinition } from '@12-apps/feature-flags';
...
/** The mounted router alone, for `mount-surfaces.ts`. */
export function featureFlagsRouter(): Hono {
  return wireFeatureFlags().router;
}
